...
import com.ws.rpc.core.serialization.hessian.HessianSerializationTest;
 ...
 * @author ws
 * @version 1.0
 * @date 2025-01-05 17:21
 */
public class KryoSerializationTest {
    @Test
    public void test() {
        Serialization serialization = SerializationFactory.getSerialization(SerializationType.KRYO);
